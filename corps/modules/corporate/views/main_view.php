...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<!-- header -->
			<?php include("tpl_sliders.php"); ?> 
			<!-- end header -->

			<!-- service -->
			<?php include("tpl_services.php"); ?> 
			<!-- end service -->

			<!-- about -->
			<?php include("tpl_about.php"); ?> 
			<!-- end about -->
			...
			<!-- team -->
			<?php include("tpl_team.php"); ?> 
			<!-- end team -->

			<!-- events
			<?php //include("tpl_events.php"); ?> 
			 end events -->

			<!-- actualités -->
			<?php include("tpl_actualites_recentes.php"); ?> 
			<!-- end actualités -->
