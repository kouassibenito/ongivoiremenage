					...
					<div class="row">
						<div class="col-lg-6 text-center text-lg-left hidden-xs">
							<div class="inline-content big-spacing">
								<div class="page_social"> <a class="social-icon socicon-facebook" href="<?php if(isset($facebook)) echo $facebook; ?>" title="Facebook"></a> <a class="social-icon socicon-twitter" href="<?php if(isset($twitter)) echo $twitter; ?>" title="Twitter"></a>  <a class="social-icon socicon-linkedin"
									    href="<?php if(isset($linkedln)) echo $linkedln; ?>" title="Linkedin"></a> <a class="social-icon socicon-youtube" href="<?php if(isset($youtube)) echo $youtube; ?>" title="Youtube"></a> </div> <span class="xs-block">
						<i class="fa fa-clock-o highlight3 rightpadding_5" aria-hidden="true"></i>
						
						<?php if(isset($horaire_travail)) echo $horaire_travail; ?>
					</span> </div>
						</div>
						<div class="col-lg-6 text-center text-lg-right">
							...
							<a href="mailto:info@ongivoiremenage.org"><?php if(isset($email )) echo $email; ?></a>
								...
								<div id="topline-show" class="widget widget_search">
									<form method="get" class="searchform inline-form" action="http://webdesign-finder.com/html/diversify/">
										<div class="form-group-wrap">
											<div class="form-group"> <label class="sr-only" for="topline-widget-search">Search for:</label> <input id="topline-widget-search" type="text" value="" name="search" class="form-control" placeholder="Enter Keyword..."> <a href="index.html" id="search-close">
