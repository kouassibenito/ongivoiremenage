			...
			<section class="ls section_padding_top_100 section_padding_bottom_100">
				<div class="container">
                       ...
                       <?php
						...
						if(isset($actualites_description)){

							foreach ($actualites_description as $info) { ?>


					<div class="row">
						<div class="col-xs-12"> <img src="<?php echo base_url(); ?>uploads/actualites/<?php if(isset($info->image )) echo $info->image; ?>" alt="" class="alignright">
