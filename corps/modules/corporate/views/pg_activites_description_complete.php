			...
			<section class="ls section_padding_top_100 section_padding_bottom_100">
				<div class="container">
					...
					<?php
						...
						if(isset($activite_description)){

							foreach ($activite_description as $info) { ?>

					<div class="row">
						<div class="col-xs-12"> <img src="<?php echo base_url(); ?>uploads/activite/<?php if(isset($info->image )) echo $info->image; ?>" alt="" class="alignright">
							<h2 class="section_header topmargin_0"><?php if(isset($info->nom_activite )) echo $info->nom_activite; ?></h2>
