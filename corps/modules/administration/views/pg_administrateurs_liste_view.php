<div class="page-header mt-0 shadow p-3">
								...
								<div class="btn-group mb-0">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="#"><i class="fas fa-plus mr-2"></i>Ajouter une activité</a>
										<a class="dropdown-item" href="#"><i class="fas fa-eye mr-2"></i>Voir le formulaire d'ajout</a>
										<a class="dropdown-item" href="#"><i class="fas fa-edit mr-2"></i>Editer une activité</a>
