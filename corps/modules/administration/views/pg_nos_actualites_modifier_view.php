	...
	<ol class="breadcrumb mb-sm-0">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="card shadow">
										<div class="card-header">
											...
											<div  class="row">
				                                    <div class="col-sm">
				                           <form action="<?php echo base_url(); ?>administration/upload_actualite_modifier" method="POST" class="dropzone">
								...
								<div class="col-md-6" style="padding-left:10px;">
                                    ...
                                    <img width="80%" src="<?php echo base_url(); ?>uploads/actualites/<?php echo $img; ?>">
								</div>
