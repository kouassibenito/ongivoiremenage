...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouvelle couleur ajoutée avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajouter nouvelle couleur</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgCouleur');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_couleur" name="id_couleur"  type="hidden" value="<?php if(isset($id_couleur)) echo $id_couleur; ?>">
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>Glisser et deposer l'image.</h4>
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajouter nouvelle couleur</h5>
                                            <div class="form-desc">Ajouter nouvelle couleur</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_couleur"  type="text" value="">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <textarea id="commentaire_couleur" class="form-control" rows="3"></textarea>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var libelle_couleur=$( "#libelle_couleur" ).val();
                    var commentaire_couleur=$( "#commentaire_couleur" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutCouleur',
                                           dataType:'html',
                                           data: {
