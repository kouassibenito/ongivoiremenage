...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> utilisateur ajouté avec succès</div>

                   <div id="zone_id">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau utilisateur</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgMarques');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_administrateur" name="id_administrateur"  type="hidden" value="<?php if(isset($id_administrateur)) echo $id_administrateur; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau utilisateur</h5>
                                            <div class="form-desc">Ajout nouveau utilisateur</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_administrateur"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="prenom_administrateur"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="fonction_administrateur"  type="text" value="">
                                                    </div>
                                                </div>   
                                            </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_administrateur"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="telephone_administrateur"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
...
$( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutUtilisateur',
                                           dataType:'html',
                                           data: {
