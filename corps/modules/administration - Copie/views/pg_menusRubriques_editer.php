                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout rubrique menu principal</h6>
...
<?php
  if(isset($infos_rubriquesID)){
     ...
     $id_menu_principale=$itemflash->id_menu_principale;
     $libelle_menu_choisi=$this->administration_model->infosMenus_id_nom($id_menu_principale);
     ...
     ?>
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadEditerImgRubriques');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout rubrique menu principal</h5>
                                            <div class="form-desc">Ajout d'une rubrique dans le menu principal ...</div>
...
<?php }
 ...
 ?> 
                                            ...
                                            <div class="form-buttons-w">
                                                <button class="btn btn-primary" id="button_submit" type="submit"> Modirier</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    console.log( "ready!" );
               ...
               $( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerRubriques',
                                           dataType:'html',
                                           data: {
