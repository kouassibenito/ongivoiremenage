                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des depots du stock</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des depots du stock</h5>
                                <div class="form-desc">informations sur les depots du stock </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infosDepot_stock)){
                                                                                          
                                                                                          foreach ($infosDepot_stock as $mag){ 
                                                                                              
                                                                                             $libelle_depot=$mag->libelle_depot;  
                                                                                             $localisation=$mag->localisation;
                                                                                             $id_magasin=$mag->id_magasin;
                                                                                    $magasin=$this->administration_model->get_magasin_info($id_magasin);
                                                          ...
                                                          <tr>
                                                                    ...
                                                                    <td class="left"><?php echo $libelle_depot; ?></td>
                                                                    
                                                                    <td class="left"><?php echo $localisation; ?></td>
                                                                     <td class="left"><?php echo $magasin; ?></td>
