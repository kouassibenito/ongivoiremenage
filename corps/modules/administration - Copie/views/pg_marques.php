                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des marques</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des marques</h5>
                                <div class="form-desc">informations sur les marques </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutMarques" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une nouvelle marque</a>
                                   
                                </div>
                                <br><br/>
                               Rechercher une marque:<input type="text" id="search_boxID" placeholder="" size="80">
                                 <br><br/>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                          ...
                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_marques)){
                                                                                          
                                                                                          foreach ($infos_marques as $marque){ 
...
?>
                                             ...
                                             <td class="left"><?php echo $compt; ?></td>
                                                                    <td class="left"><?php echo $libelle_marque; ?></td>
                                                                                        
                                                                    <td class="left"><?php echo $commentaire; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerMarques/<?php echo $id_marque; ?>"><i class="os-icon os-icon-ui-49"></i></a>
