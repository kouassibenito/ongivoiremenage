...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Groupe stock ajouté avec succès</div>
 ...
 <input class="form-control" id="id_groupe"  type="hidden" value="<?php echo $id_groupe; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau groupe stock</h5>
                                            <div class="form-desc">Ajout nouveau groupe stock</div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_groupe"  type="text" value="">
                                                    </div>
                                                </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for=""> Selectionner groupe principal</label>
                                                        <select class="form-control" id="id_groupe_principale">
                                                            <option value="0">Aucun groupe principal</option>
                                                            <?php 

                                                              if(isset($infosGroupe_stock)){
                                                                 foreach($infosGroupe_stock as $elmet){ 


                                                                 ?>

                                                                   <option value="<?php echo $elmet->id_groupe;  ?>"><?php echo $elmet->libelle_groupe;  ?></option>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="commentaire_groupe"  type="text" value="">
                                                    </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var id_groupe_principale=$( "#id_groupe_principale" ).val();
                    var libelle_groupe=$( "#libelle_groupe" ).val();
                    var commentaire_groupe=$( "#commentaire_groupe" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxGroupe_stock',
                                           dataType:'html',
                                           data: {
