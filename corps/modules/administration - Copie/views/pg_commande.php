                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des commandes</h6>
                            <a href="<?php echo base_url(); ?>administration" class="btn btn-primary"> Retour à la page d'accueil</a>
                            <div class="element-box">
                                <h5 class="form-header">Listes des commandes</h5>
                                <div class="form-desc">informations sur les commandes </div>

                              <br><br/>
                               Rechercher une commande:<input type="text" id="search_input" placeholder="" size="80">
                                 <br><br/>
                               
                                <div class="table-responsive" id="result_zone">
                                                                      ...
                                                                      <td class="text-center">
                                                                        ...
                                                                        <?php
                                                                         if($status_commande == "5"){ ?>
                                                                             ...
                                                                             <span style="color: red">Echec livraison client</span>
...
-------------------->
    ...
    <script>
      ...
      var recherche_item=$('#search_input').val();
      var longueur_recherche=$('#search_input').val().length;
      ...
      console.log(recherche_item);
        ...
        $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/listeProduits_commande',
                                           dataType:'html',
                                           data: {
                                               
                                               search_input:recherche_item,
