                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des temoignages</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des temoignages</h5>
                                <div class="form-desc">informations sur les temoignages </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutTemoignages" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un nouveau temoignage</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_temoignages)){
                                                                                          
                                                                                          foreach ($infos_temoignages as $temoignage){ 
                                                                                              $id_temoignages=$temoignage->id_temoignages;
...
?>
                                                ...
                                                <td class="left"><?php echo $temoignage->nom_prenom; ?></td>
                                                                                        
                                                <td class="left"><?php echo $temoignage->message; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerTemoignages/<?php echo $id_temoignages; ?>"><i class="os-icon os-icon-ui-49"></i></a>
