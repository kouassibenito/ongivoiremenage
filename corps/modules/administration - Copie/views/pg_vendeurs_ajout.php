                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau vendeur</h6>
...
<input class="form-control" id="id_fournisseur"  type="hidden" value="<?php if(isset($id_fournisseur)) echo $id_fournisseur; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau vendeur</h5>
                                            <div class="form-desc">Ajout nouveau vendeur</div>
...
$( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutVendeurs',
                                           dataType:'html',
                                           data: {
