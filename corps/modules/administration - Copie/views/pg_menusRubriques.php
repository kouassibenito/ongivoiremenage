                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des rubriques menu principal</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes rubriques menu principal</h5>
                                <div class="form-desc">Ce sont les rubriques à l'interieur du menu principale </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutRubrique" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une rubrique menu principal</a>
                                             ...
                                             <?php
                                               ...
                                               ?>
                                                <tr>
                                                 ...
                                                 <td class="left"><?php echo $menu_associe; ?></td>
                                                 
                                                  <td class="row-actions">
                                                    <a href="editerRubrique/<?php echo $id_menu_group; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="supprim_rubrique/<?php echo $id_menu_group; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
