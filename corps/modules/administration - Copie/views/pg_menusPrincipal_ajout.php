...
-------------------->
 ...
 <input class="form-control" id="id_menu_principale"  type="hidden" value="<?php if(isset($id_menu_principale)) echo $id_menu_principale; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="menu_principale"  type="text" value="">
                                                    </div>
                                                </div>
    ...
    console.log( "ready!" );
        ...
        $( "#button_submit" ).click(function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo base_url(); ?>administration/ajaxAjoutMenuPrincipale',
                dataType:'html',
                data: {
