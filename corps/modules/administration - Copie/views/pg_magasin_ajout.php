...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Magasins ajouté avec succès</div>

                   <div id="zone_id">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau magasin</h6>
 ...
 <input class="form-control" id="id_magasin"  type="hidden" value="<?php echo $id_magasin; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau magasin</h5>
                                            <div class="form-desc">Ajout nouveau magasin</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_magasin"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="telephone_magasin"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_magasin"  type="text" value="">
                                                    </div>
                                                </div>   
                                            </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="type_magasin"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_gerant_magasin"  type="text" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="prenom_gerant_magasin"  type="text" value="">
                                                    </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_gerant_magasin"  type="text" value="">
                                                    </div>
                                                </div>
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="telephone_gerant_magasin"  type="text" value="">
                                                    </div>
                                                </div>

                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for=""> Selectionner le type de magasin</label>
                                                        <select class="form-control" id="id_magasin_type">
                                                            <option value="">selectionner le type de magasin</option>
                                                            <?php 

                                                              if(isset($liste_type_magasin)){
                                                                 foreach($liste_type_magasin as $elmet){ 

                                                                 $libelle=$elmet->type_magasin;
                                                                 if($libelle <> "e-commerce"){
                                                                 ...
                                                                 ?>
                                                                   ...
                                                                   <option value="<?php echo $elmet->id_magasin_type;  ?>"><?php echo $elmet->type_magasin;  ?></option>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var id_magasin_type=$( "#id_magasin_type" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutMagasin',
                                           dataType:'html',
                                           data: {
                                               ...
                                               id_magasin_type:id_magasin_type,
