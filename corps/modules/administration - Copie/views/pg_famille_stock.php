                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des Familles du stock</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des Familles du stock</h5>
                                <div class="form-desc">informations sur les Familles du stock </div>
                                    ...
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infosFamille_stock)){
                                                                                          ...
                                                                                          foreach ($infosFamille_stock as $mag){ 
                                                                                              
                                                                                             $id_famille_produit=$mag->id_famille_produit;  
                                                                                             $libelle_famille_produit=$mag->libelle_famille_produit;
                                                                                             $commentaire=$mag->commentaire;
                                                          ...
                                                          <tr>
                                                                    ...
                                                                    <td class="left"><?php echo $libelle_famille_produit; ?></td>
                                                                    
                                                                    <td class="left"><?php echo $commentaire; ?></td>
                                                                    
                                                                   
                                                                      
					                                                  <td class="row-actions">
					                                                    <a href="<?php echo base_url(); ?>administration/editerMagasin/<?php echo $id_famille_produit; ?>"><i class="os-icon os-icon-ui-49"></i></a>
