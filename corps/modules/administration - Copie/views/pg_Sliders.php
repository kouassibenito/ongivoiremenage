                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des Sliders</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des sliders</h5>
                                <div class="form-desc">Listes des sliders</div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutSlider" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un nouveau slide</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <td class="left"><?php echo $libelle_sliders; ?></td>
                                                <td class="left"><?php echo $lien_clickable; ?></td>
                                                  <td class="row-actions">
                                                    <a href="<?php echo base_url(); ?>administration/editerSlider/<?php echo $id_sliders; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="<?php echo base_url(); ?>administration/supprim_slider/<?php echo $id_sliders; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
