...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouvelle pointure chaussure ajoutée avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajouter nouvelle pointure chaussure</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgPointureChaussure');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_pointure_chaussure" name="id_pointure_chaussure"  type="hidden" value="<?php if(isset($id_pointure_chaussure)) echo $id_pointure_chaussure; ?>">
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>Glisser et deposer l'image ici.</h4>
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajouter nouvelle pointure chaussure</h5>
                                            <div class="form-desc">Ajouter nouvelle pointure chaussure</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Pointure chaussure</label>
                                                       
                                                        <input class="form-control" id="libelle_pointure_chaussure"  type="text" value="">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <textarea id="commentaire_pointure_chaussure" class="form-control" rows="3"></textarea>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var id_pointure_chaussure=$( "#id_pointure_chaussure" ).val();
                    var libelle_pointure_chaussure=$( "#libelle_pointure_chaussure" ).val();
                    var commentaire_pointure_chaussure=$( "#commentaire_pointure_chaussure" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutPointureChaussure',
                                           dataType:'html',
                                           data: {
