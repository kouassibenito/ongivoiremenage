...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Categorie produit edité avec succès.
                         </div>
                            ...
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    ...
                                    <div class="element-box">
                                        ...
                                        <form>
                                            <h5 class="form-header">editer menu catégorie</h5>
                                            <div class="form-desc">menu catégorie dans le menu categorie ...</div>

              
<?php
  if(isset($infos_categorieProduitID)){

     foreach($infos_categorieProduitID as $itemflash){ 

         $id_categorie_produit=$itemflash->id_categorie_produit;
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_categorie_produit"  type="text" value="<?php echo $itemflash->libelle_categorie_produit; ?>">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo base_url(); ?>admin/ajaxEditerCategorieProduits',
                dataType:'html',
                data: {
