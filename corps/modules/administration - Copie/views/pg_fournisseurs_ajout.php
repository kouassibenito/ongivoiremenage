...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Fournisseur ajouté avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau fournisseur</h6>
...
<input class="form-control" id="id_fournisseur"  type="hidden" value="<?php if(isset($id_fournisseur)) echo $id_fournisseur; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau fournisseur</h5>
                                            <div class="form-desc">Ajout nouveau fournisseur</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Entreprise fournisseur</label>
                                                       

                                                        <input class="form-control" id="entreprise_fournisseur"  type="text" value="">
                                                    </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_fournisseur"  type="text" value="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="prenom_fournisseur"  type="text" value="">
                                                    </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_fournisseur"  type="text" value="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="tel_fournisseur"  type="text" value="">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="localisation"  type="text" value="">
                                                    </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutFournisseurs',
                                           dataType:'html',
                                           data: {
