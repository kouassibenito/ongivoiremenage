...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Categorie produit ajouté avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout categorie produit</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgCategorieProduits');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_categorie_produit" name="id_categorie_produit"  type="hidden" value="<?php if(isset($id_categorie_produit)) echo $id_categorie_produit; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout menu catégorie</h5>
                                            <div class="form-desc">menu catégorie dans le menu categorie ...</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">Designation categorie produit</label>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="id_menu_principale">
                                                            <option value="">Selectionner le menu principale</option>



                                                             <?php
                                                                if(isset($liste_menu_p)){ 
                                                                                         
                                                                    foreach ($liste_menu_p as $menu){
                                                            ?>
                                                                                    
                                                                 <option value="<?php echo $menu->id_menu_principale; ?>"><?php echo $menu->libelle_menu_principale; ?></option>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""> Selectionner la rubrique associé au menu principale</label>
                                                        <select class="form-control" id="id_rubrique">
                                                            <option value="">Selectionner la rubrique associé au menu principale</option>



                                                             <?php
                                                                if(isset($liste_rubrique)){ 
                                                                                         
                                                                    foreach ($liste_rubrique as $menu){
                                                            ?>
                                                                                    
                                                                 <option value="<?php echo $menu->id_menu_group; ?>"><?php echo $menu->libelle_menu_group; ?></option>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""> selectionner la categorie principale</label>
                                                        <select class="form-control" id="id_menu_categorie_principale">
                                                            <option value="">selectionner la categorie principale</option>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""> Selectionner la rubrique associé a la categorie principale</label>
                                                        <select class="form-control" id="id_menu_group_categorie">
                                                            <option value="">Selectionner la rubrique associé a la categorie principale</option>



   
                                                             <?php
                                                                if(isset($liste_rubriqueCategories)){ 
                                                                                         
                                                                    foreach ($liste_rubriqueCategories as $menu){
                                                            ?>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
            ...
            var id_menu_principale=$("#id_menu_principale").val();
            var id_rubrique=$("#id_rubrique").val();

            var id_menu_categorie_principale=$("#id_menu_categorie_principale").val();
            var id_menu_group_categorie=$("#id_menu_group_categorie").val();
            
            var commentaire=$("#commentaire").val();


            console.log("id categorie "+id_menu_categorie_principale);
            console.log(" id_menu_group_categorie "+id_menu_group_categorie);
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo base_url(); ?>admin/ajaxAjoutCategorieProduits',
                dataType:'html',
                data: {
