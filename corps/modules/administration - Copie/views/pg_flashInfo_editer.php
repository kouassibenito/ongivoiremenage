...
<?php
  if(isset($infos_FlashInfos)){

     foreach($infos_FlashInfos as $itemflash){ 

     ?>
     <input class="form-control" id="id_flash_infos"  type="hidden" value="<?php if(isset($itemflash->id_flash_infos)) echo $itemflash->id_flash_infos; ?>">

      <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Titre flash info</label>
                                                       
                                                        <input class="form-control" id="titre_flash_info"  type="text" value="<?php if(isset($itemflash->titre_flash_info)) echo $itemflash->titre_flash_info; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Etiquette </label>
                                                        <input class="form-control" id="etiquette_flash_infos" type="text" value="<?php if(isset($itemflash->etiquette_flash_infos)) echo $itemflash->etiquette_flash_infos; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Commentaire</label>
                                                        <input class="form-control" id="commentaire"  type="text" value="<?php if(isset($itemflash->commentaire)) echo $itemflash->commentaire; ?>">
                                                    </div>
                                                </div>
                                            </div>

                                              <div class="form-group">
                                                    <label> Flash d'informations</label>
                                                    <textarea id="infos_flash_infos" class="form-control" rows="3"><?php if(isset($itemflash->infos_flash_infos)) echo $itemflash->infos_flash_infos; ?></textarea>
    </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
      ...
      $( "#button_submit" ).click(function(e) {
                    ...
                    var titre_flash_info=$( "#titre_flash_info" ).val();
                    var etiquette_flash_infos=$( "#etiquette_flash_infos" ).val();
                    var infos_flash_infos=$( "#infos_flash_infos" ).val();
                    var commentaire=$("#commentaire").val();
                    var id_flash_infos=$("#id_flash_infos").val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerFlashInfos',
                                           dataType:'html',
                                           data: {
