...
-------------------->
                    <ul class="main-menu">
                        <li class="has-sub-menu">
                            ...
                            <ul class="sub-menu">
                                <li><a href="index-2.html">Manager</a></li>
                                <li><a href="apps_support_dashboard.html">Responsable vente</a></li>
                                <li><a href="apps_projects.html">Gestionnaire du stock</a></li>
                                <li><a href="apps_bank.html">Agent du support</a></li>
