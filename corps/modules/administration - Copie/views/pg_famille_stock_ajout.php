...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> famille stock ajouté avec succès</div>

                   <div id="zone_id">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau groupe stock</h6>
                                    <div class="element-box">

                                         <div class="element-wrapper">
                  

 <input class="form-control" id="id_famille_produit"  type="hidden" value="<?php echo $id_famille_produit; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau famille stock</h5>
                                            <div class="form-desc">Ajout nouveau famille stock</div>
                                            ...
                                            <div class="row">
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for=""> Selectionner famille principal</label>
                                                        <select class="form-control" id="id_famille_principale">
                                                            <option value="0">Aucun famille principal</option>
                                                            <?php 

                                                              if(isset($infosFamille_stock)){
                                                                 foreach($infosFamille_stock as $elmet){ 


                                                                 ?>

                                                                   <option value="<?php echo $elmet->id_famille_produit;  ?>"><?php echo $elmet->libelle_famille_produit;  ?></option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_famille_produit"  type="text" value="">
                                                    </div>
                                                </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var id_famille_produit=$( "#id_famille_produit" ).val();
                    var id_famille_principale=$( "#id_famille_principale" ).val();
                    var libelle_famille_produit=$( "#libelle_famille_produit" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxFamille_stock',
                                           dataType:'html',
                                           data: {
