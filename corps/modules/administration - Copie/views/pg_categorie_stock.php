                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des catégories du stock</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des catégories du stock</h5>
                                <div class="form-desc">informations sur les catégories du stock </div>
                                    ...
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infosCategories_stock)){
                                                                                          ...
                                                                                          foreach ($infosCategories_stock as $mag){ 
                                                                                              
                                                                                             $id_categorie_produit=$mag->id_categorie_produit;  
                                                                                             $libelle_categorie_produit=$mag->libelle_categorie_produit;
                                                          ...
                                                          <tr>
                                                                    ...
                                                                    <td class="left"><?php echo $libelle_categorie_produit; ?></td>
                                                                    ...
                                                                    <td class="left"><?php echo $commentaire; ?></td>
					                                                  ...
					                                                  <td class="row-actions">
					                                                    <a href="<?php echo base_url(); ?>administration/editerMagasin/<?php echo $id_categorie_produit; ?>"><i class="os-icon os-icon-ui-49"></i></a>
