...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> vendeur ajouté avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Modifier les informations du vendeur</h6>
                                    <div class="element-box">
                                        ...
                                        <form>
                                            <h5 class="form-header">Modifier les informations du vendeur</h5>
                                            <div class="form-desc">Modifier les informations du vendeur</div>

<?php
  if(isset($infos_FournisseurID)){

     foreach($infos_FournisseurID as $itemflash){ 

         $id_fournisseur=$itemflash->id_fournisseur;

    
     ?>

     <input class="form-control" id="id_fournisseur"  type="hidden" value="<?php if(isset($id_fournisseur)) echo $id_fournisseur; ?>">
 
                                          
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Entreprise vendeur</label>
                                                       

                                                        <input class="form-control" id="entreprise_fournisseur"  type="text" value="<?php echo $itemflash->entreprise_fournisseur; ?>">
                                                    </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_fournisseur"  type="text" value="<?php echo $itemflash->nom_fournisseur; ?>">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="prenom_fournisseur"  type="text" value="<?php echo $itemflash->prenom_fournisseur; ?>">
                                                    </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="email_fournisseur"  type="text" value="<?php echo $itemflash->email_fournisseur; ?>">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="tel_fournisseur"  type="text" value="<?php echo $itemflash->tel_fournisseur; ?>">
                                                    </div>
                                                </div>
                                                 ...
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="localisation"  type="text" value="<?php echo $itemflash->localisation; ?>">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="pass_fournisseur"  type="text" value="<?php echo $itemflash->pass_fournisseur; ?>">
                                                    </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var entreprise_fournisseur=$( "#entreprise_fournisseur" ).val();
                    var nom_fournisseur=$( "#nom_fournisseur" ).val();
                    var prenom_fournisseur=$( "#prenom_fournisseur" ).val();
                    var tel_fournisseur=$( "#tel_fournisseur" ).val();
                    var email_fournisseur=$( "#email_fournisseur" ).val();
                    var localisation=$( "#localisation" ).val();
                     var pass_fournisseur=$( "#pass_fournisseur" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerVendeurs',
                                           dataType:'html',
                                           data: {
