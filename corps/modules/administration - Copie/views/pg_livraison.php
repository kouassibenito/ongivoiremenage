                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des livraisons</h6>
                            <a href="<?php echo base_url(); ?>administration" class="btn btn-primary"> Retour à la page d'accueil</a>
                            <div class="element-box">
                                <h5 class="form-header">Listes des livraisons</h5>
                                <div class="form-desc">informations sur les livraisons </div>

                                 <br><br/>
                                Rechercher un info de livraison :<input type="text" id="search_boxID" placeholder="" size="80">
                                <br>
...
-------------------->
    ...
    <script>
      ...
      $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/listeLivraison_par_recherche',
                                           dataType:'html',
                                           data: {
