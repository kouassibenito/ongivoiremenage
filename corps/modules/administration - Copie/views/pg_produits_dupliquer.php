...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Dupliquer  avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Dupliquer un produit</h6>
...
?>
                                            ...
                                            <div class="form-buttons-w">
                                                <button class="btn btn-primary" id="button_submit" type="submit"> Dupliquer</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxDupliquerProduit',
                                           dataType:'html',
                                           data: {
