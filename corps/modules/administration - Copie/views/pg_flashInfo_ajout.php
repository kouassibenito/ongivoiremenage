...
-------------------->
 ...
 <input class="form-control" id="id_flash_infos"  type="hidden" value="<?php if(isset($id_flash_infos)) echo $id_flash_infos; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="titre_flash_info"  type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Etiquette </label>
                                                        <input class="form-control" id="etiquette_flash_infos" type="text" value="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <textarea id="infos_flash_infos" class="form-control" rows="3"></textarea>
                                                </div>
    ...
    console.log( "ready!" );
      ...
      $( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutFlashInfos',
                                           dataType:'html',
                                           data: {
