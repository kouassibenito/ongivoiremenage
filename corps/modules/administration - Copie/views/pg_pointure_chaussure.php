                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des pointures de chaussure</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des pointures de chaussure</h5>
                                <div class="form-desc">informations sur les pointures de chaussure </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutPointureChaussure" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une nouvelle pointure de chaussures</a>
                                   
                                </div>
                                <br><br/>
                               Rechercher une pointure de chaussure:<input type="text" id="search_boxID" placeholder="" size="80">
                                 <br><br/>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                          ...
                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_pointure_chaussure)){
                                                                                          
                                                                                          foreach ($infos_pointure_chaussure as $PointureChaussure){ 
                                                                                              $id_pointure_chaussure=$PointureChaussure->id_pointure_chaussure;

                                                                                              $libelle_pointure_chaussure =$PointureChaussure->libelle_pointure_chaussure ;
                                                                                              $commentaire_pointure_chaussure =$PointureChaussure->commentaire_pointure_chaussure ;
...
?>
                                             ...
                                             <td class="left"><?php echo $compt; ?></td>
                                                                    <td class="left"><?php echo $libelle_pointure_chaussure; ?></td>
                                                                                        
                                                                    <td class="left"><?php echo $commentaire_pointure_chaussure; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerMarques/<?php echo $id_pointure_chaussure; ?>"><i class="os-icon os-icon-ui-49"></i></a>
