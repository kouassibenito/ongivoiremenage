...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouvelle marque editée avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Editer nouvelle marque</h6>
                                    <div class="element-box">

                                         

                                        <form>
                                            <h5 class="form-header">Ajouter nouvelle marque</h5>
                                            <div class="form-desc">Ajouter nouvelle marque</div>
 ...
 <?php
  if(isset($infos_marquesID)){
     ...
     ?>
      ...
      <input class="form-control" id="id_marque"  type="hidden" value="<?php echo $itemflash->id_marque; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_marque"  type="text" value="<?php echo $itemflash->libelle_marque; ?>">
                                                    </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var libelle_marque=$( "#libelle_marque" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerMarques',
                                           dataType:'html',
                                           data: {
