                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des produits</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des produits</h5>
                                <div class="form-desc">informations sur les produits </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutProduit_stock" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un nouveau produit</a>
                                    <a href="<?php echo base_url();?>administration" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Retour à l'accueil</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                           ...
                                           <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_produit)){
                                                                                          
                                                                                          foreach ($infos_produit as $produit){ 
...
?>
                                               ...
                                               <td class="left"><?php echo $compt; ?></td>
                                                <td class="left"><?php echo $nom_produit; ?></td>
                                                <td class="left"><?php echo $prix_achat; ?></td>
                                                                                        
                                               <td class="left"><?php echo $prix_produit; ?></td>
                                                  <td class="left"><?php echo $prix_solde; ?></td>
                                                   <td class="left"><?php echo $quantite_totale; ?></td>
                                                    <td class="left"><?php echo $quantite_restante; ?></td>
                                                    <td class="left"><?php echo $stock_minimum; ?></td>
