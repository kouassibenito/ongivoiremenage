                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout menu categorie</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgMenusCategoriePrincipale');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_menu_categorie_principale" name="id_menu_categorie_principale"  type="hidden" value="<?php if(isset($id_menu_categorie_principale)) echo $id_menu_categorie_principale; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="categorie_principale"  type="text" value="">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>admin/ajaxAjoutMenusCategoriePrincipale',
                                           dataType:'html',
                                           data: {
