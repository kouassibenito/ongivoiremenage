                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des menus principaux</h6>
                            <div class="element-box">
                                <h5 class="form-header">Menus principaux</h5>
                                <div class="form-desc">Les menus principaux sont les menus qui s'affiche de manière horizontale en haut du e-commerce</div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutMenusPrincipal" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un menu principal</a>
                                            ...
                                            <tbody>
                                                 ...
                                                 <?php
                                                     $compt=0;
                                                      ...
                                                      if(isset($infos_MenusPrincipaux)){
                                                                                          
                                                       foreach ($infos_MenusPrincipaux as $menu){ 
                                                             $id_menu_principale=$menu->id_menu_principale;
                                                             $compt=$compt+1;
                                                ?>
                                                <tr>
                                                    
                                                 <td class="left"><?php echo $compt; ?></td>
                                                 <td class="left"><?php echo $menu->libelle_menu_principale; ?></td>
                                                 <td class="left"><?php echo $menu->position; ?></td>
                                                 <td class="left"><?php echo $this->administration_model->compterRubriqueMenuPrincipale($id_menu_principale); ?></td>
                                                 <td class="left"><?php echo $this->administration_model->compterSousMenu($id_menu_principale); ?></td>
                                                  <td class="row-actions">
                                                    <a href="<?php echo base_url(); ?>administration/editerMenusPrincipal/<?php echo $id_menu_principale; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="supprimMenuPrincipal/<?php echo $id_menu_principale; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
