                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des Groupes du stock</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des Groupes du stock</h5>
                                <div class="form-desc">informations sur les Groupes du stock </div>
                                    ...
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infosGroupe_stock)){
                                                                                          ...
                                                                                          foreach ($infosGroupe_stock as $mag){ 
                                                                                              
                                                                                             $id_groupe=$mag->id_groupe;  
                                                                                             $libelle_groupe=$mag->libelle_groupe;
                                                                                             $commentaire_groupe=$mag->commentaire_groupe;
                                                          ...
                                                          <tr>
                                                                    ...
                                                                    <td class="left"><?php echo $libelle_groupe; ?></td>
                                                                    
                                                                    <td class="left"><?php echo $commentaire_groupe; ?></td>
                                                                    
                                                                   
                                                                      
					                                                  <td class="row-actions">
					                                                    <a href="<?php echo base_url(); ?>administration/editerMagasin/<?php echo $id_groupe; ?>"><i class="os-icon os-icon-ui-49"></i></a>
