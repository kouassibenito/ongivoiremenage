                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout menu catégorie menu principal</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgRubriqueCategorie');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="">Designation rubrique menu categorie</label>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for=""> Selectionner le menu categorie</label>
                                                        <select class="form-control" id="id_menu_categorie_principale">
                                                            <option value="">selectionner un menu categorie principale</option>
    ...
    console.log( "ready!" );
               ...
               $( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutRubriqueCategorie',
                                           dataType:'html',
                                           data: {
