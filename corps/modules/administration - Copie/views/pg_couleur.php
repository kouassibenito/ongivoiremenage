                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des couleurs</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des couleurs</h5>
                                <div class="form-desc">informations sur les couleurs </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutCouleur" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une nouvelle couleur</a>
                                   
                                </div>
                                <br><br/>
                               Rechercher une couleur:<input type="text" id="search_boxID" placeholder="" size="80">
                                 <br><br/>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                          ...
                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_couleur)){
                                                                                          
                                                                                          foreach ($infos_couleur as $couleur){ 
                                                                                              $id_couleur=$couleur->id_couleur;

                                                                                              $libelle_couleur=$couleur->libelle_couleur;
                                                                                              $commentaire_couleur =$couleur->commentaire_couleur ;
...
?>
                                             ...
                                             <td class="left"><?php echo $compt; ?></td>
                                                                    <td class="left"><?php echo $libelle_couleur; ?></td>
                                                                                        
                                                                    <td class="left"><?php echo $commentaire_couleur; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerMarques/<?php echo $id_couleur; ?>"><i class="os-icon os-icon-ui-49"></i></a>
