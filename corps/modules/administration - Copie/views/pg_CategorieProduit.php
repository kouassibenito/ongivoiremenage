                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des categories produits</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des categories produits</h5>
                                <div class="form-desc"> </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutCategoriesProduits" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une categorie produit</a>
                                   
                                </div>
                                <br><br/>
                                Rechercher une catégorie produit:<input type="text" id="search_boxID" placeholder="Taper ici le libellé du produit" size="80">
                                 <br><br/>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            <thead>
                                                ...
                                                <th>Menu principale / Rubrique </th>
                                                <th>Catégorie principale / Rubrique</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                        $compt=0;
                                               if(isset($infos_categorieProduit)){

                                                 foreach ($infos_categorieProduit as $categorieProduit){
                                                    $id_categorie_produit=$categorieProduit->id_categorie_produit;
                                                    $id_menu_categorie_principale=$categorieProduit->id_menu_categorie_principale;
                                                     $id_menu_group_categorie=$categorieProduit->id_menu_group_categorie;
                                                    $id_menu_principale=$categorieProduit->id_menu_principale;
                                                    $menu_associe=$this->administration_model->infosMenuRubriques($id_menu_principale);

                                                    $id_rubrique=$categorieProduit->id_menu_group;

                                                    $rubrique_associe=$this->administration_model->infoRubriquesAss($id_rubrique);

                                                    $categorie_associe=$this->administration_model->infosCategoriesPrinc($id_menu_categorie_principale);

                                                    $rubrique_categorie_associe=$this->administration_model->infoRubriquesAss($id_menu_group_categorie);
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="left"><?php echo $categorieProduit->libelle_categorie_produit; ?></td>
                                                   <td class="left"><?php echo $menu_associe; ?> / <?php echo $rubrique_associe; ?></td>
                                                   <td class="left"><?php echo $categorie_associe; ?> / <?php echo $rubrique_categorie_associe; ?></td>
                                                 
                                                  <td class="row-actions">
                                                    <a href="editerCategoriesProduits/<?php echo $id_categorie_produit; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="supprimCategorieProduit/<?php echo $id_categorie_produit; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
