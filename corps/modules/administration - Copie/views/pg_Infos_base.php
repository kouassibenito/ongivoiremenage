<?php
   ...
   if(isset($infos_generales)){
       foreach ($infos_generales as $info){
           
            $logo=$info->url_logo;
            $message_bienvenue=$info->message_bienvenue;
  
            $telephone=$info->telephone;
            $localisation=$info->localisation;
            $email_commercial=$info->email_commercial;
            $email_newsletter=$info->email_newsletter;
...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Informations de base enregistré avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Informations générale</h6>
                                    <div class="element-box">
                                                 <div class="element-wrapper">
                           
                                                    <div class="element-box">
                                                       
                                                        <form action="<?php echo base_url('administration/upload_logo');?>" class="dropzone" id="my-awesome-dropzone">
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h4>Glisser et deposer le logo pour le replacer.</h4>
                                        ...
                                        <form>
                                            <h5 class="form-header">Informations de base</h5>
                                            <div class="form-desc">ce sont les informations qui permettent de definir les contours généraux du e-commerce tel que le logo , le mail support ,etc ...</div>

                                             <div class="form-group">
                                                    <label> Description de la boutique</label>
                                                    <textarea id="message_bienvenue" class="form-control" rows="3"><?php echo $message_bienvenue; ?></textarea>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="telephone"  type="text" value="<?php echo $telephone; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Email support</label>
                                                        <input class="form-control" id="mail_sale" type="text" value="<?php echo $email_commercial; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Email newsletter</label>
                                                        <input class="form-control" id="mail_newsletter"  type="text" value="<?php echo $email_newsletter; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="facebook"  type="text" value="<?php echo $facebook; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Twitter</label>
                                                        <input class="form-control" id="twitter" type="text" value="<?php echo $twitter; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Google +</label>
                                                        <input class="form-control" id="googleplus"  type="text" value="<?php echo $googleplus; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="Youtube"  type="text" value="<?php echo $youtube; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <label for="">localisation</label>
                                                        <input class="form-control" id="mail_sale" type="text" value="<?php echo $localisation; ?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="copyright"  type="text" value="<?php echo $copyright; ?>">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
   ...
   $( "#button_submit" ).click(function(e) {
                    e.preventDefault();
                    var message_bienvenue=$( "#message_bienvenue" ).val();
                    var telephone=$("#telephone").val();
                    var localisation=$("#localisation").val();
                    var mail_sale=$( "#mail_sale" ).val();
                    ...
                    $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutInfosGenerale',
                                           dataType:'html',
                                           data: {
