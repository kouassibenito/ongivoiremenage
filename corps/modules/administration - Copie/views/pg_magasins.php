                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des magasins</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des magasins</h5>
                                <div class="form-desc">informations sur les magasins </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_Magasins)){
                                                                                          
                                                                                          foreach ($infos_Magasins as $mag){ 
                                                                                              
                                                                                             $id_magasin=$mag->id_magasin;  
                                                                                             $libelle_magasin=$mag->libelle_magasin;
                                                                                             $email_magasin=$mag->email_magasin;
                                                                                             $telephone_magasin=$mag->telephone_magasin;
                                                                                             $type_magasin=$mag->type_magasin;
                                                                                             $nom_gerant_magasin=$mag->nom_gerant_magasin." ".$mag->prenom_gerant_magasin;
                                                                                             $telephone_gerant_magasin=$mag->telephone_gerant_magasin;
                                                                                             $status=$mag->status;
                                                          ...
                                                          <tr>
                                                                    ...
                                                                    <td class="left"><?php echo $libelle_magasin; ?></td>
                                                                    
                                                                    <td class="left"><?php echo $telephone_magasin; ?></td>
                                                                    
                                                                    <td class="left"><?php echo $type_magasin; ?></td>
                                                                     <td class="left"><?php echo $nom_gerant_magasin; ?></td>
                                                                    ...
                                                                    <td class="text-center">
					                                                  ...
					                                                  <td class="row-actions">
					                                                    <a href="<?php echo base_url(); ?>administration/editerMagasin/<?php echo $id_magasin; ?>"><i class="os-icon os-icon-ui-49"></i></a>
