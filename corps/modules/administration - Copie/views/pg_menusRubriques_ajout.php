                                    ...
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgRubriques');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_rubrique"  type="text" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="id_menu_principale">
                                                            <option value="">selectionner un menu principale</option>
    ...
    console.log( "ready!" );
               ...
               $( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutRubriques',
                                           dataType:'html',
                                           data: {
