                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des rubriques menu categorie</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes rubriques menu categorie</h5>
                                <div class="form-desc">Ce sont les rubriques à l'interieur du menu categorie </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutRubriqueCategorie" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une rubrique  menu categorie</a>
...
?>
                                             <?php
                                                 ...
                                                 $compt=0;
                                                 if(isset($infos_rubriques)){
                                                                                          
                                                    foreach ($infos_rubriques as $menu){ 
                                                    $id_menu_group=$menu->id_menu_group;
                                                      $id_menu_principale=$menu->id_menu_principale;
                                                      $id_menu_categorie_principale=$menu->id_menu_categorie_principale;
                                                      $id_rubrique=$menu->id_menu_group;
                                                      $menu_cat=$this->administration_model->infosMenuCategoriesPrincipale_liblle($id_menu_categorie_principale);
                                               ...
                                               ?>
                                                <tr>
                                                 ...
                                                 <td class="left"><?php echo $menu->libelle_menu_group; ?></td>
                                                                                        
                                                 <td class="left"><?php echo $menu_cat; ?></td>
                                                 
                                                  <td class="row-actions">
                                                    <a href="editerRubriqueCategorie/<?php echo $id_menu_group; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="supprim_rubriqueC/<?php echo $id_menu_group; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
