                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajouter une taille de chemises</h6>
                                    <div class="element-box">


                                        <form>
                                            <h5 class="form-header">Ajouter une taille de chemises</h5>
                                            <div class="form-desc">Ajouter une taille de chemises...</div>

    
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                        <label for="">libelle taille de chemises</label>
