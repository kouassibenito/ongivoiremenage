                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des tailles de chemise</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des tailles de chemise</h5>
                                <div class="form-desc">informations sur les tailles de chemise </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutTailleChemise" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter une nouvelle taille de chemise</a>
                                   
                                </div>
                                <br><br/>
                               Rechercher une taille de chemise:<input type="text" id="search_boxID" placeholder="" size="80">
                                 <br><br/>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                          ...
                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_taille_chemise)){
                                                                                          
                                                                                          foreach ($infos_taille_chemise as $TailleChemise){ 
                                                                                              $id_taille_chemise=$TailleChemise->id_taille_chemise;

                                                                                              $libelle_taille_chemise =$TailleChemise->libelle_taille_chemise ;
                                                                                              $commentaire_taille_chemise  
 =$TailleChemise->commentaire_taille_chemise  
 ;
...
?>
                                             ...
                                             <td class="left"><?php echo $compt; ?></td>
                                                                    <td class="left"><?php echo $libelle_taille_chemise; ?></td>
                                                                                        
                                                                    <td class="left"><?php echo $commentaire_taille_chemise; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerMarques/<?php echo $id_taille_chemise; ?>"><i class="os-icon os-icon-ui-49"></i></a>
