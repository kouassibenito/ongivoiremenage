                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des types de magasins</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des types de magasins</h5>
                                <div class="form-desc">informations sur les types de magasins </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                                          <?php
                                                                                     $compt=0;
                                                                                      if(isset($infosMagasins_type)){
                                                                                          
                                                                                          foreach ($infosMagasins_type as $mag){ 
                                                                                              
                                                                                             $id_magasin_type=$mag->id_magasin_type;  
