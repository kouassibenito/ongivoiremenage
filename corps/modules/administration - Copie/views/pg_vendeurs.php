                ...
                <div class="content-i">
                    <div class="content-box">
                        ...
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des vendeurs</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des vendeurs</h5>
                                <div class="form-desc">informations sur les vendeurs </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutVendeurs" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un nouveau vendeur</a>
                                    
                                </div>

                                <br></br>
                                   Rechercher un vendeur:<input type="text" id="search_input" placeholder="" size="100"   />
                                 <br></br>
    ...
    <script>
      ...
      var longueur_recherche=$('#search_input').val().length;
        ...
        $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/listeVendeurs',
                                           dataType:'html',
                                           data: {
