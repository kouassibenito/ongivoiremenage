...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Partenaire edité avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Editer nouveau partenaire</h6>
                                    <div class="element-box">

<?php
  if(isset($infos_partenairesID)){

     foreach($infos_partenairesID as $itemflash){ 

         $id_partenaires=$itemflash->id_partenaires;
     ...
     ?>
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadEditerImgPartenaires');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_partenaires" name="id_partenaires"  type="hidden" value="<?php if(isset($id_partenaires)) echo $id_partenaires; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau partenaire</h5>
                                            <div class="form-desc">Ajout nouveau partenaire ...</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Libellé partenaire</label>
                                                       
                                                        <input class="form-control" id="libelle_partenaire"  type="text" value="<?php echo $itemflash->libelle_partenaire; ?>">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <textarea id="commentaire" class="form-control" rows="3"><?php echo $itemflash->commentaire; ?></textarea>
                                                </div>
<?php }
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
               ...
               $( "#button_submit" ).click(function(e) {
                    ...
                    var id_partenaires=$( "#id_partenaires" ).val();
                    var libelle_partenaire=$( "#libelle_partenaire" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerPartenaires',
                                           dataType:'html',
                                           data: {
