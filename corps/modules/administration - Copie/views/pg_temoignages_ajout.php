                                    ...
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadModImgTemoignages');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_prenom"  type="text" value="">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutTemoignage',
                                           dataType:'html',
                                           data: {
