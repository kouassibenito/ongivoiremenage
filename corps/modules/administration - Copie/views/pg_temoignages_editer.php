...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Partenaire ajouté avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau partenaire</h6>
                                    <div class="element-box">

                                         <div class="element-wrapper">

<?php
  if(isset($id_temoignagesID)){

     foreach($id_temoignagesID as $itemflash){ 

         $id_temoignages=$itemflash->id_temoignages;
     ...
     ?>
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadEditerModImgTemoignages');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_temoignages" name="id_temoignages"  type="hidden" value="<?php if(isset($id_temoignages)) echo $id_temoignages; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau temoignage</h5>
                                            <div class="form-desc">Ajout nouveau temoignage</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="nom_prenom"  type="text" value="<?php echo $itemflash->nom_prenom; ?>">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                    <label> message</label>
                                                    <textarea id="message" class="form-control" rows="3"><?php echo $itemflash->message; ?></textarea>
                                                </div>
<?php }
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
                    ...
                    e.preventDefault();
                    var id_temoignages=$( "#id_temoignages" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerTemoignage',
                                           dataType:'html',
                                           data: {
