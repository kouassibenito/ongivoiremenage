...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouvelle taille de chemise ajoutée avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajouter nouvelle taille de chemise
                                    ...
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgTailleChemise');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_taille_chemise" name="id_taille_chemise"  type="hidden" value="<?php if(isset($id_taille_chemise)) echo $id_taille_chemise; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajouter nouvelle taille de chemise</h5>
                                            <div class="form-desc">Ajouter nouvelle taille de chemise</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Taille de chemise</label>
                                                       
                                                        <input class="form-control" id="libelle_taille_chemise"  type="text" value="">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <textarea id="commentaire_taille_chemise" class="form-control" rows="3"></textarea>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var id_taille_chemise=$( "#id_taille_chemise" ).val();
                    var libelle_taille_chemise=$( "#libelle_taille_chemise" ).val();
                    var commentaire_taille_chemise=$( "#commentaire_taille_chemise" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutTailleChemise',
                                           dataType:'html',
                                           data: {
