...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouvelle couleur editée avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Editer nouvelle couleur</h6>
 ...
 <?php
  if(isset($infos_marquesID)){

     foreach($infos_marquesID as $itemflash){ 

        $id_marque=$itemflash->id_marque;

    
     ?>

      <input class="form-control" id="id_marque"  type="hidden" value="<?php echo $itemflash->id_couleur; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_couleur"  type="text" value="<?php echo $itemflash->libelle_couleur; ?>">
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <textarea id="commentaire_couleur" class="form-control" rows="3"><?php echo $itemflash->commentaire; ?></textarea>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxEditerCouleur',
                                           dataType:'html',
                                           data: {
