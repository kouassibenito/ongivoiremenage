...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> famille depot ajouté avec succès</div>

                   <div id="zone_id">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau depot stock</h6>
                                    <div class="element-box">

                                         <div class="element-wrapper">
                  

 <input class="form-control" id="id_depot"  type="hidden" value="<?php echo $id_depot; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau depot stock</h5>
                                            <div class="form-desc">Ajout nouveau depot stock</div>
                                            ...
                                            <div class="row">
                                                 <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for=""> Selectionner le magasin</label>
                                                        <select class="form-control" id="id_magasin">
                                                            <option value="0">Selectionner le magasin</option>
                                                            <?php 

                                                              if(isset($infosMagasins)){
                                                                 foreach($infosMagasins as $elmet){ 


                                                                 ?>

                                                                   <option value="<?php echo $elmet->id_magasin;  ?>"><?php echo $elmet->libelle_magasin;  ?></option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_depot"  type="text" value="">
                                                    </div>
                                                </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                    ...
                    var id_depot=$( "#id_depot" ).val();
                    var id_magasin=$( "#id_magasin" ).val();
                    var libelle_depot=$( "#libelle_depot" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxDepot_stock',
                                           dataType:'html',
                                           data: {
