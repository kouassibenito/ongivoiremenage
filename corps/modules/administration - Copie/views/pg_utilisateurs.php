                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Listes des utilisateurs</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des utilisateurs</h5>
                                <div class="form-desc">informations sur les utilisateurs </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutUtilisateur" class="mr-2 mb-2 butilisateurtn btn-outline-primary" type="button"> Ajouter une nouveau utilisateur</a>
                                   
                                </div>

                                <br><br/>
                                Rechercher un utilisateur :<input type="text" id="search_boxID" placeholder="" size="80">
                                 <br><br/>
                                                ...
                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
					                                                  ...
					                                                  <td class="row-actions">
					                                                    <a href="<?php echo base_url(); ?>administration/editerUtilisateur/<?php echo $id_administrateur; ?>"><i class="os-icon os-icon-ui-49"></i></a>
					                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
					                                                    <a class="danger" href="<?php echo base_url(); ?>administration/suppressionUtilisateur/<?php echo $id_administrateur; ?>"><i class="os-icon os-icon-ui-15"></i></a>
					                                                  </td>
                                                </tr>
...
-------------------->
    ...
    <script>
      ...
      $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/listeUtilisateur_par_recherche',
                                           dataType:'html',
                                           data: {
