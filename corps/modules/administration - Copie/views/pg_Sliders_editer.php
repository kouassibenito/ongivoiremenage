...
if(isset($infos_slider)){


    
    foreach($infos_slider as $slider){


       $id_sliders=$slider->id_sliders;
       $libelle_sliders=$slider->libelle_sliders;
       $lien_clickable=$slider->lien_clickable;
...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Edité slide avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">edité slide</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/editer_uploadSlider');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_sliders" name="id_sliders"  type="hidden" value="<?php if(isset($id_sliders)) echo $id_sliders; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouveau slide</h5>
                                            <div class="form-desc">Ajout nouveau slide ...</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">libellé slide</label>
                                                       
                                                        <input class="form-control" id="libelle_sliders"  type="text" value="<?php if(isset($libelle_sliders)) echo $libelle_sliders; ?>">
                                                    </div>
                                                </div>

                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Url slider</label>
                                                       
                                                        <input class="form-control" id="lien_clickable"  type="text" value="<?php if(isset($lien_clickable)) echo $lien_clickable; ?>">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
                    ...
                    var id_sliders=$( "#id_sliders" ).val();
                    var libelle_sliders=$( "#libelle_sliders" ).val();
                    var lien_clickable=$( "#lien_clickable" ).val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxediterSlider',
                                           dataType:'html',
                                           data: {
