                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout menu principal</h6>
                                    <div class="element-box">

                                        <form>
                                            <h5 class="form-header">Ajout menu principal</h5>
                                            <div class="form-desc">Ajout d'un menu principal ...</div>

<?php
  if(isset($infos_MenusPrincipauxID)){

     foreach($infos_MenusPrincipauxID as $itemflash){ 

     ?>

         <input class="form-control" id="id_menu_principale"  type="hidden" value="<?php echo $itemflash->id_menu_principale; ?>">
                      
                                          
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="">Designation menu principal</label>
                                                       
                                                        <input class="form-control" id="menu_principale"  type="text" value="<?php echo $itemflash->libelle_menu_principale; ?>">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
        ...
        $( "#button_submit" ).click(function(e) {
            e.preventDefault();
            var menu_principale=$( "#menu_principale" ).val();
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo base_url(); ?>administration/ajaxediterMenuPrincipale',
                dataType:'html',
                data: {
