                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="element-box">
                                                            ...
                                                            <form action="<?php echo base_url('administration/upload_logo_block1');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                                <input class="form-control" id="id_rubrique" name="id_rubrique"  type="hidden" value="<?php if(isset($id_rubrique)) echo $id_rubrique; ?>">
                                                                <div class="dz-message">
                                                                    <div>
                                                                        <h2>Glisser et deposer le image pour le replacer block1.</h2>
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="url_pub_block1"  type="text" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/upload_logo_block2');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_rubrique" name="id_rubrique"  type="hidden" value="<?php if(isset($id_rubrique)) echo $id_rubrique; ?>">
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h2>Glisser et deposer le image pour le replacer block2.</h2>
                                                                    <div class="text-muted"></div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                ...
                                                <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="url_pub_block2"  type="text" value="">
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                   <div class="form-group"> 
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/upload_logo_block3');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_rubrique" name="id_rubrique"  type="hidden" value="<?php if(isset($id_rubrique)) echo $id_rubrique; ?>">
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h2>Glisser et deposer le image pour le replacer block3.</h2>
                                                                    <div class="text-muted"></div>
                                                                </div>
                                                            </div>
                                                           </form>
                                                    ...
                                                    <div class="form-group">
                                                            <label for="">Url image block 3</label>
                                                           
                                                            <input class="form-control" id="url_pub_block3"  type="text" value="">
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/upload_logo_block4');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_rubrique" name="id_rubrique"  type="hidden" value="<?php if(isset($id_rubrique)) echo $id_rubrique; ?>">
                                                            <div class="dz-message">
                                                                <div>
                                                                    <h2>Glisser et deposer le image pour le replacer block4.</h2>
                                                                    <div class="text-muted"></div>
                                                                </div>
                                                            </div>
                                                        </form>
                                                ...
                                                <div class="form-group">
                                                            <label for="">Url image block 4</label>
                                                           
                                                            <input class="form-control" id="url_pub_block4"  type="text" value="">
                                                    </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
               ...
               $( "#button_submit" ).click(function(e) {
                    ...
                    var url_pub_block1=$( "#url_pub_block1" ).val();
                    var url_pub_block2=$( "#url_pub_block2" ).val();
                    
                    var url_pub_block3=$("#url_pub_block3").val();
                    var url_pub_block4=$("#url_pub_block4").val();
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutBloc14',
                                           dataType:'html',
                                           data: {

                                              non_value:non_value,
                                               
                                               url_pub_block1:url_pub_block1,
                                               url_pub_block2:url_pub_block2,
                                               url_pub_block3:url_pub_block3,
                                               url_pub_block4:url_pub_block4,
