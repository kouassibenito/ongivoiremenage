                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des partenaires</h6>
                            <div class="element-box">
                                <h5 class="form-header">Listes des partenaires</h5>
                                <div class="form-desc">informations sur les partenaires </div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutPartenaires" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un nouveau partenaire</a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                             <?php
                                                                                     $compt=0;
                                                                                      if(isset($infos_partenaires)){
                                                                                          
                                                                                    foreach ($infos_partenaires as $temoignage){ 
                                                                                        $id_partenaires=$temoignage->id_partenaires;
                                                ...
                                                <tr>
                                                 ...
                                                 <td class="left"><img src="<?php echo base_url(); ?>uploads/partenaires/<?php echo $temoignage->url_img; ?>"></td>
                                                                                        
                                                  <td class="left"><?php echo $temoignage->libelle_partenaire; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerPartenaires/<?php echo $id_partenaires; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="supprimPartenaires/<?php echo $id_partenaires; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
