                                    ...
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgPartenaires');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_partenaire"  type="text" value="">
                                                    </div>
                                                </div>
    ...
    console.log( "ready!" );
               ...
               $( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>admin/ajaxAjoutPartenaires',
                                           dataType:'html',
                                           data: {
