                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Montant dus aux fournisseurs</h6>
                            <div class="element-box">
                                <h5 class="form-header">Montant dus aux fournisseurs</h5>
                                <div class="form-desc">informations sur les fournisseurs </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-lg table-v2 table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $montantapayer=$this->administration_model->getMontantdu_fournisseur($id_fournisseur);
