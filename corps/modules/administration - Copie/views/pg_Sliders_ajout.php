...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouveau slide ajouté avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouveau slide</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                                    ...
                                                    <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadSlider');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_sliders"  type="text" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="lien_clickable"  type="text" value="">
                                                    </div>
                                                </div>
...
$( document ).ready(function() {
    ...
    console.log( "ready!" );
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutSlider',
                                           dataType:'html',
                                           data: {
