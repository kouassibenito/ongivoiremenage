                ...
                <div class="content-i">
                    <div class="content-box">
                        <div class="element-wrapper">
                            <h6 class="element-header">Liste des flash informations</h6>
                            <div class="element-box">
                                <h5 class="form-header">Flash d'informations</h5>
                                <div class="form-desc">Les flash d'informations sont des informations defilantes en haut du e-commerce</div>

                                <div class="element-box-content">
                                    <a href="<?php echo base_url();?>administration/ajoutFlashInfos" class="mr-2 mb-2 btn btn-outline-primary" type="button"> Ajouter un flash d'informations</a>
                                                 ...
                                                 <?php
                                                     $compt=0;
                                                      ...
                                                      if(isset($infos_FlashInfos)){
                                                        ...
                                                        foreach ($infos_FlashInfos as $info){ 
                                                          $id_flash_infos=$info->id_flash_infos;
                                                          $compt=$compt+1;
                                                ?>
                                                <tr>
                                                    
                                                  <td class="left"><?php echo $compt; ?></td>
                                                  <td class="left"><?php echo $info->titre_flash_info; ?></td>                                      
                                                  <td class="left"><?php echo $info->etiquette_flash_infos; ?></td>
                                                  <td class="left"><?php echo $info->infos_flash_infos; ?></td>
                                                  <td class="row-actions">
                                                    <a href="editerlashInfos/<?php echo $id_flash_infos; ?>"><i class="os-icon os-icon-ui-49"></i></a>
                                                    <!--<a href="#"><i class="os-icon os-icon-grid-10"></i></a> -->
                                                    <a class="danger" href="supprim_flashInfo/<?php echo $id_flash_infos; ?>"><i class="os-icon os-icon-ui-15"></i></a>
                                                  </td>
                                                </tr>
