...
-------------------->
                ...
                <div class="content-i">
                    ...
                    <div class="content-box">
                         ...
                         <div class="alert alert-success" id="succes_box" role="alert"><strong>Succès! </strong> Nouvelle marque ajouté avec succès.
                         </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">Ajout nouvelle marque</h6>
                                    <div class="element-box">
                                         ...
                                         <div class="element-wrapper">
                                             ...
                                             <div class="element-box">
                                                        ...
                                                        <form action="<?php echo base_url('administration/uploadImgMarques');?>" class="dropzone" id="my-awesome-dropzone" method="POST">
                                                            <input class="form-control" id="id_marque" name="id_marque"  type="hidden" value="<?php if(isset($id_marque)) echo $id_marque; ?>">
                                        ...
                                        <form>
                                            <h5 class="form-header">Ajout nouvelle marque</h5>
                                            <div class="form-desc">Ajout nouvelle marque</div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="libelle_marque"  type="text" value="">
                                                    </div>
                                                </div>
...
$( "#button_submit" ).click(function(e) {
                ...
                $.ajax({
                                           ...
                                           type: 'POST',
                                           url: '<?php echo base_url(); ?>administration/ajaxAjoutMarques',
                                           dataType:'html',
                                           data: {
